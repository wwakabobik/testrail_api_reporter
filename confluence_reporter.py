...
class ConfluenceReporter:
    def __init__(self, url, username, password, debug=True, confluence_page=None, automation_platforms=None,
                 plotly_engine=None):
        ...
        self.__debug = debug if debug else True
    ...
    def history_state_chart(self, confluence_page, automation_platforms=None, debug=None, ):
        ...
        for item in automation_platforms:
            if debug:
                print('generating chart for {}'.format(item['name']))
